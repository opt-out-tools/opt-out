...
class Model:
    ...
    def build(self, path_to_data, text_column_name, label_column_name, hyperparameters, save_word_embeddings, save_model):
        ...
        model.fit(partial_x_train, partial_y_train, epochs=hyperparameters['epoch'], batch_size=hyperparameters['batch_size'], validation_data=(x_val, y_val),
